...
import ru.dlevin.excelmapper.engine.CompositeRectangle;
 ...
 * Date: 10.03.14
 */
public class TwoColumnsBlocksConatinerGroupImplTest {
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            group.addCell(new CellCoordinate(0, 0), property("number"));
            group.addCell(new CellCoordinate(0, 1), property("title"));
