package ru.dlevin.excelmapper.samples.read;
...
import ru.dlevin.excelmapper.engine.converters.DateStringConverter;
import ru.dlevin.excelmapper.samples.domain.*;

import java.io.BufferedInputStream;
import java.io.IOException;
import java.io.InputStream;

import static ru.dlevin.excelmapper.engine.References.converter;
...
public class ReadInvoice {
    public static void main(String[] args) throws IOException, InvalidFormatException {
        ...
        try {
            fileInput = new BufferedInputStream(ReadInvoice.class.getClassLoader().getResourceAsStream("invoice.xls"));
